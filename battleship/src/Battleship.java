...
public class Battleship
{
  public static void main(String[] args)
  {
    ...
    while(addNew)
    {
      System.out.println("Type \"a\" to add new ship, \"b\" to see the board, \"p\" to " + 
      "play \"f\" to test foundShip, \"g\" to test game over,or \"q\" to quit.");
      String ans = scan.nextLine();
      if(ans.toLowerCase().equals("q"))
        return;
      else if(ans.toLowerCase().equals("f")){
        System.out.println("Input len");
        int l = scan.nextInt();
        System.out.println("foundShip: " + b.foundShip(l));

      }
      else if(ans.toLowerCase().equals("a"))
      {
      ...
      else if(ans.toLowerCase().equals("g"))
        {System.out.println("\n" + "call gamover result:" +  b.gameOver() + "\n");
       }
    }
    ...
    while(!b.gameOver())
    {
      System.out.println("Press \"s\" to shoot at a square, \"b\" to see the board, \"f\" to test foundShip, \"g\" to test game over,\"q\" to quit.");
      String ans = scan.nextLine();
      if(ans.toLowerCase().equals("q"))
        return;
      else if(ans.toLowerCase().equals("f")){
